...
Page({
  ...
  //一键发送所有数据
  sureTap: function(e){
    console.log(this.data.job.comname,this.data.job.work,this.data.job.scale,this.data.job.money,this.data.job.duty,this.data.job.demand,this.data.job.way)
    wx.request({
      url: 'http://localhost:8000/api/job/new',
      method: 'POST',
      header: {
